...
(function ($) {
    ...
    $.fn.fileinput.locales.en = {
        ...
        uploadLabel: '上传',
        uploadTitle: '上传选中文件',
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超出最大限制 <b>{maxSize} KB</b>. 清重新上传!',
        msgFilesTooLess: '文件过少，你至少要选择 <b>{n}</b> {files} 上传. 请重新上传!',
        msgFilesTooMany: '文件过多，选中文件<b>({n})</b>个，超出了最多限制  <b>{m}</b>. 清重新上传!',
        ...
        dropZoneTitle: '也可以把文件拖到这里&hellip;'
    };
